...
class MainViewModel @ViewModelInject constructor(
    ...
    private val runsSortedByTimeinMilis = mainRepository.getAllRunsSortedByTimeInMillis()
    ...
    fun sortRuns(sortType: SortType) = when(sortType){
        ...
        SortType.RUNNING_TIME -> runsSortedByTimeinMilis.value?.let {runs.value = it}
    }.also {
